...
describe("assignment1", function () {
  ...
  it("Login_with_any_user_then_add_lowest_price_product_then_remove_the_item", function () {
    ...
    cy.get(this.locator.inventoryList)
      .find(this.locator.inventoryItem)
      .eq(0)
      .contains("Add to cart")
      .click(); //add lowest price product to the cart
    cy.goToCart(); //go to cart
    cy.verifyCheckout(this.locator.itemName, this.text.oneSize1); //verifying the item name
